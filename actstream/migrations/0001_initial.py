    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor_object_id', models.CharField(max_length=191, db_index=True, help_text='')),
                ('verb', models.CharField(max_length=191, db_index=True, help_text='')),
                ('description', models.TextField(blank=True, null=True, help_text='')),
                ('target_object_id', models.CharField(max_length=191, blank=True, null=True, db_index=True, help_text='')),
                ('action_object_object_id', models.CharField(max_length=191, blank=True, null=True, db_index=True, help_text='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, help_text='', auto_created=True)),
                ('object_id', models.CharField(max_length=191, db_index=True, help_text='')),
